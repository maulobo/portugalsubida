...
const initialForm = {
  tipoOperacion: "Consulta sobre propiedad",
  nombrePropiedad: "",
  nombre: "",
  email: "",
  phoneNumber: "",
...
const FormPropiedades = () => {
  const validationsForm = (form) => {
    ...
    let errors = {};
    if (!form.nombrePropiedad.trim()) {
      errors.nombrePropiedad = `Debe ingresar el nombre de la propiedad por la que desea consultar.`;
    }
    if (!form.nombre.trim()) {
      ...
      <FormMio method="POST" onSubmit={handleSubmit}>
        ...
        <Form.Group className="mb-3" controlId="formBasicEmail">
          <Form.Control
            ...
            placeholder="Nombre de la propiedad a consultar"
            onBlur={handleBlur}
            onChange={handleChange}
